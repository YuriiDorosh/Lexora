...
- M30: AI Speaking Coach (active development) — `/my/speaking` portal
  with mic recording, Faster-Whisper transcription, and Qwen-powered
  feedback (corrections / synonyms / improved version)
